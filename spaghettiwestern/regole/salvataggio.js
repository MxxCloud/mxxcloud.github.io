...
// Spaghetti western è una copia di Ultimo raccolto (M7.18.41) che vive
// accanto all'originale sullo stesso sito, e l'archivio del browser è uno per
// sito: con il prefisso di prima le due si sarebbero lette le caselle a
// vicenda.
const PREFISSO = "spaghettiwestern/";
...
export function nomeFile(stato) {
  ...
  return `spaghettiwestern-${stato.seme}-giorno${stato.giorno}-${stagione}.json`;
}
